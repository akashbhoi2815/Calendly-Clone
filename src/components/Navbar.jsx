        ...
        >
          <Box>
            <Link to="/">
              <img
                width="150px"
                src="https://mma.prnewswire.com/media/1682590/Calendly__Logo.jpg?w=200"
              />
            </Link>
          </Box>
                      ...
                      <GridItem width="500px">
                        <Box p={5}>
                          <Link to="/">
                            ...
                            <Text mt={1}>
                              Flexible, intuitive features for every
                              <br /> scheduling need.
                            </Text>
                          </Link>
                          <br />
                          ...
                          >
                            <Box width="200px">
                              <ChevronDownIcon />
                              <Link to="#">
                                <Heading as="h6" size="2sm">
                                  Routing Forms
                                </Heading>
                                <Text fontSize="xs">
                                  Request information to efficiently screen and
                                  qualify prople before they can schedule with
                                  you.
                                </Text>
                              </Link>
                            </Box>
                            <Box width="200px">
                              ...
                              <Link to="#">
                                ...
                                <Text fontSize="xs">
                                  Add Calendly on your website to steamline
                                  scheduling.
                                </Text>
                              </Link>
                            </Box>
                            ...
                            <Box width="200px">
                              ...
                              <Link to="#">
                                ...
                                <Text fontSize="xs">
                                  Connect up to six calendars per user to check
                            ...
                            <Box width="200px">
                              ...
                              <Link to="#">
                                ...
                                <Text fontSize="xs">
                                  Let your invitees vote on preferred times
                                  before scheduling.
                                </Text>
                              </Link>
                            </Box>
                      ...
                      >
                        <Box p={5}>
                          <Link to="#">
                            ...
                            <Text mt={1}>
                              Explore how thought leaders in your industry use
                              Calendly
                            </Text>
                          </Link>
                          <br />
                          ...
                          <Box mt={5}>
                            <Link to="#">
                              ...
                              <Text fontSize="sm">
                                Seamless connections to your favorite calendars,
                                tools and apps.
                              </Text>
                            </Link>
                          </Box>
                      ...
                      <GridItem bg="#DAEAF1" width="250px">
                        <Box p={5}>
                          <Link to="">
                            ...
                            <Text mt={1}>
                              More in-depth information about every corner of
                              the Calendly scheduling ecosystem.
                            </Text>
                          </Link>
                        </Box>
                      </GridItem>
