       ...
       <div>
        ...
        {showTime && (
            ...
            <div style={{display:"flex",width:"250px",height:"50px",flexDirection:"row",justifyContent:"space-around"}}>
             <Stack>
             <button style={{background:"blue",width:"100px",borderRadius:"10px",color:"white",padding:"5px"}}>10:30 am</button>
          ...
          <button style={{marginTop:"45%",padding:'2%',marginLeft:"10px",border:"1px solid blue",width:"100px",borderRadius:"10px",background:"blue",color:"white"}} type='submit'>Next</button>
          </div>
        )}
        </div>
    </div>
